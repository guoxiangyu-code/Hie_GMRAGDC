"""Train CG-DETR or CG-DETR-GMR on Soccer-GMR precomputed features."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output_dir", default="artifacts/cg_detr_gmr/run")
    ...
    parser.add_argument(
        ...
        help="auto: positive for cg_detr; mixed for cg_detr_gmr",
    )
...
def _save_checkpoint(
    ...
    *, training_state: dict | None = None,
    ...
    payload = {
            ...
            "config": vars(args),
            "metrics": metrics,
            "source_revision": "212b2e49a0893512930d63b9294a8c066347e606",
        }
...
def main(argv: list[str] | None = None) -> None:
    ...
    if sample_mode == "auto":
        sample_mode = "positive" if args.variant == "cg_detr" else "mixed"
    ...
    args.positive_count_class_counts = positive_count_histogram
    ...
    if args.init_checkpoint:
        ...
        if args.use_phrase_grounding:
            allowed_new_prefixes.append("phrase_grounding.")
    ...
    if args.resume:
        ...
        primary_name = "mAP" if args.variant == "cg_detr" else "joint"
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if (epoch + 1) % args.eval_interval == 0:
            submission = predict(
                ...
                # Checkpoint selection always uses the full localization view;
                # threshold/adaptive decoding is a post-hoc validation/test view.
                decode_mode="full",
            ...
            for metric_name, score in scores.items():
                ...
                primary_name = "joint" if args.variant != "cg_detr" else "mAP"
