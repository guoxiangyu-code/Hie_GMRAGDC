...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed, video_length=None, moment_idx=None, msrc=None, mpos=None, mmask=None,
        ...
        ### Normalize
        frame_importance = (frame_importance / frame_importance.sum(1, keepdim=True).clamp_min(1e-6)) * frame_importance.size(1)  # b 75
        ...
        src_ = src.new_zeros((len(fr_token_sim), self.d_model))
        ...
        tgt = src.new_zeros((refpoint_embed.shape[0], bs, d))
